...
func (uc *UsersCreate) SetIntroduction(s string) *UsersCreate {
...
func (uc *UsersCreate) check() error {
	...
	if _, ok := uc.mutation.Introduction(); !ok {
		return &ValidationError{Name: "introduction", err: errors.New(`ent: missing required field "Users.introduction"`)}
	}
	return nil
}
