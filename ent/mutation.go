...
func (m *UsersMutation) SetIntroduction(s string) {
	m.introduction = &s
}

// Introduction returns the value of the "introduction" field in the mutation.
func (m *UsersMutation) Introduction() (r string, exists bool) {
	v := m.introduction
	if v == nil {
		return
	}
...
// OldIntroduction returns the old "introduction" field's value of the Users entity.
// If the Users object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UsersMutation) OldIntroduction(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *UsersMutation) ResetIntroduction() {
	m.introduction = nil
}
...
func (m *UsersMutation) Fields() []string {
	...
	if m.introduction != nil {
		fields = append(fields, users.FieldIntroduction)
	}
	return fields
}
