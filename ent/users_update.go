...
func (uu *UsersUpdate) SetIntroduction(s string) *UsersUpdate {
...
func (uu *UsersUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := uu.mutation.Introduction(); ok {
		_spec.SetField(users.FieldIntroduction, field.TypeString, value)
	}
...
// SetIntroduction sets the "introduction" field.
func (uuo *UsersUpdateOne) SetIntroduction(s string) *UsersUpdateOne {
